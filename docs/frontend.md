...
The `dashboard.html` serves as a master layout. Navigating between views is controlled by `switchSPAView(viewName)` and `switchTab(tabIndex)` in [dashboard.js](file:///c:/Users/bodha/OneDrive/Documents/NOTEPAY/Notepay_App/frontend/js/dashboard.js):
...
To support clean URLs in production while allowing simple local double-click file execution, [shared-utils.js](file:///c:/Users/bodha/OneDrive/Documents/NOTEPAY/Notepay_App/frontend/js/shared-utils.js) implements a dual-mode router:
...
Shared visual interfaces are structured as standard HTML Web Components (Custom Elements) defined inside [components.js](file:///c:/Users/bodha/OneDrive/Documents/NOTEPAY/Notepay_App/frontend/js/components.js):
...
On page load, Firebase occasionally fires a `null` user event briefly before restoring the user session from IndexedDB. To prevent redirecting logged-in users back to the login page (known as redirect loops), [firebase-config.js](file:///c:/Users/bodha/OneDrive/Documents/NOTEPAY/Notepay_App/frontend/js/firebase-config.js) implements:
...
Protected pages include the [auth-guard.js](file:///c:/Users/bodha/OneDrive/Documents/NOTEPAY/Notepay_App/frontend/js/auth-guard.js) script at the top:
...
1.  **Queue Insertion**: The write is intercepted by `handleOfflineWrite()` inside [api.js](file:///c:/Users/bodha/OneDrive/Documents/NOTEPAY/Notepay_App/frontend/js/api.js).
...
*   **API Client & Offline Queue**: [frontend/js/api.js](file:///c:/Users/bodha/OneDrive/Documents/NOTEPAY/Notepay_App/frontend/js/api.js) (Function: `syncOfflineQueue()`, Cache handling: `handleOfflineWrite()`)
*   **Auth Guard & Redirects**: [frontend/js/auth-guard.js](file:///c:/Users/bodha/OneDrive/Documents/NOTEPAY/Notepay_App/frontend/js/auth-guard.js) (Guard handler block, Splash Injector)
*   **Firebase Integration**: [frontend/js/firebase-config.js](file:///c:/Users/bodha/OneDrive/Documents/NOTEPAY/Notepay_App/frontend/js/firebase-config.js) (Function: `waitForAuthReady()`, Token Cache: `getIdToken()`)
*   **Web Components Layer**: [frontend/js/components.js](file:///c:/Users/bodha/OneDrive/Documents/NOTEPAY/Notepay_App/frontend/js/components.js) (Class: `NpSidebar`, Method: `connectedCallback()`)
*   **URL & Format Utilities**: [frontend/js/shared-utils.js](file:///c:/Users/bodha/OneDrive/Documents/NOTEPAY/Notepay_App/frontend/js/shared-utils.js) (Class: `NPUtils`, Helper: `parseCurrentPath()`, `buildUrl()`)
